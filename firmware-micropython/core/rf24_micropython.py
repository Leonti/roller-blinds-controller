...
class SPIDev:
    ...
    def write_readinto(self, out_buf, in_buf, in_end: int = None, out_end: int = None):
        ...
        res = bytearray(len(in_buf[:in_end]))
        self._spi.write_readinto(out_buf[:out_end], res) # in_buf[:in_end]
        in_buf[:in_end] = res
...
class RF24:
    ...
    def listen(self, is_rx: bool):
        ...
        delta_time = time.time_ns() - start_timer
